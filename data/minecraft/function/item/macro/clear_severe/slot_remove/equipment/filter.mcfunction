...
$execute if data storage _ item_data_str{components:""} if data storage _ item_data_inventory.$(slot).components run return fail
$execute unless data storage _ item_data_str{components:""} unless data storage _ item_data_inventory.$(slot).components run return fail
