...
$execute if data storage _ item_data_str{components:""} if data storage _ item_data_inventory[{Slot:$(slot)b,components:{}}] run return run say compo true
$execute unless data storage _ item_data_str{components:""} unless data storage _ item_data_inventory[{Slot:$(slot)b,components:{}}] run return run say compo false
