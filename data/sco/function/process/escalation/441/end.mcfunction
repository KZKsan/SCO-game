...
execute if score #flag game matches 1 run title @a[team=blue] title [{"text":"LEVEL UP!","bold": true, "color": "green"}]
execute if score #flag game matches 1 run title @a[team=red] title [{"text":"LEVEL KEEP→","bold": true, "color": "dark_aqua"}]
execute if score #flag game matches 2 run title @a[team=red] title [{"text":"LEVEL UP!","bold": true, "color": "green"}]
execute if score #flag game matches 2 run title @a[team=blue] title [{"text":"LEVEL KEEP→","bold": true, "color": "dark_aqua"}]