...
item replace entity @s enderchest.9 with iron_sword[item_name={"text": ">Kitプレビュー","italic": false,"color": "white"},lore=[{"translate": "sco.guide.shop.gui.kit_memory.preview_icon.descripsion.0","fallback": "保存したKitのホットバー部分が確認できる","color": "white","italic": false}],custom_data={enderface_item:1b},tooltip_display={hidden_components:["attribute_modifiers"]}]
